...
function FruitsFilter() {
  const [filterFruit, setFilterFruits] = useState(fruits);
  ...
  const fruitOnChangeHandler = (e) => {
    setinputValue(e.target.value);
  }

  return (
    <div>
      <input type="text" value={inputValue} onChange={fruitOnChangeHandler}/>
      <ul>
...
//input하나 만들고 ul하나 만들고 input에 과일이름을 검색해서 필터를 거친뒤에 li로 출력
